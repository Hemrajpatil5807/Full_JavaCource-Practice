    ...
    <div class="header">
                         ...
                         <div class="dropdown">
                            <button class="dropbtn">Services</button>
                               <div class="dropdown-content">
                                    ...
                                    <a href="select.jsp">Select Employee</a>
                                    <a href="deleteAllUser">Delete ALL Employee</a>
                                    <a href="selectAllUser">Select ALL Employee</a>
                                </div>
                         </div>
                    </li>
                    <li><a href="http://127.0.0.1:5502/Lecture-Practice/contact.html">Contact Us</a></li>
                </ul>
       ...
       <div class="section_header" id="home">
        <div class="head_content">
            <h1>Welcome to Veracity <h4> ${userName} </h4></h1>
            <h2>Trusted Name in IT</h2>
            <h3>${successMsg}</h3><br><br>
            <div class="head_butt">
